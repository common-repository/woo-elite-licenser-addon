...
class  EL_WOOCommerceAddon extends elite_licenser_woocommerce_base {
    ...
    function getSubscriptionLicense(&$licenses=[], $subscription=null,$already_checked=[])
    {
...
?>
	...
	/**
	 * The show license in buyer panel admin is generated by appsbd
	 *
        ...
        if($order instanceof  WC_Subscription){
	        ...
	        if ( function_exists('wcs_order_contains_renewal') && wcs_order_contains_renewal( $order->get_id() ) ) {
		        ...
		        foreach ( $related_subscriptions as $related_subscription ) {
			        $order=wc_get_order($related_subscription->get_parent_id());
			        break;
		        }
	        }
        }
