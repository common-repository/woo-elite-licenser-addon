...
Contributors: sarwarcse, appsbd
Donate link: https://appsbd.com/elite-licenser/
Tags: woocommerce, license key, license, license manager, software license,wordpress plugin license
...
*   It’s an add-ons of WooCommerce which is also add-on of Elite Licenser
*   Generate license code for WooCommerce digital product
*   User can see the license code into order details
*   License auto disabled when a order refund, canceled or failed



## About Elite Licenser

**[Elite Licenser](https://appsbd.com/elitepro?f=wp)** is a WordPress plugin for any types of product licensing. It also manages product updates, auto generates license code, built in Envato licensing verification system, full license control and more. It has full set of API, so you can handle it by other applications as well. One app handles license of all your products. You can handle any language (PHP, .Net, Java, Android, etc.). Also you can add licensing to more than one WordPress plugin or theme and it can be installed on same WordPress.
[![Watch Video](https://appsbd.com/etc/video-button.gif)](http://bit.ly/elite-videos)

[youtube https://www.youtube.com/watch?v=f8hQQ-UVj9k]
### Features Summary
...
*   **URL Based Restrictions:**This app restrict a license key with URL that means, if someone installed your app example.com/app and also install example.com/app2 or app2.example.com then for each case it they required individual license key if purchase single license key. So no more usage after buying a single license.
...
*   **Addons:** There are many addon will be come for additional feature in future. You can use that addon too.

## **It is also supported by**

![](https://appsbd.com/etc/FastSpringAndPaddle.jpg)

## along with other payment gateways

### Demo Site Infomation

URL: [https://demo.appsbd.com/elite-license/wp-admin](https://demo.appsbd.com/elite-license/wp-admin)
User : **demo**
Password: **demo**

[![Appsbd Support](http://appsbd.com/etc/support.jpg)](https://support.appsbd.com)
...
3. Now, WooCommerce >> Elite Licenser Settings
4. You can set Remote or Local App configuration
5. Now Link you WooCommerce product with Elite License product
6. That's it
URL: [https://www.youtube.com/embed/f8hQQ-UVj9k](https://www.youtube.com/embed/f8hQQ-UVj9k)
...
= Is it works on woocommerce for auto generate license code? =

Yes, if you map woocommerce product with elite licenser product then on order it will generate license code for each mapped product based on there quantity.

== Screenshots ==

1. Menu of Elite Licenser addon lite
2. UI of elite Licenser
3. Elite Licenser dropdown in Product meta box
...
* Fixed minor bug
= 1.0.2 =
* Added elite licenser product dropdown box into variation product too.
= 1.1 =
* Bug fixed
= 1.2 =
* Bug fixed
...
* Bug fixed
= 1.7 =
* On renew or resubscribe new license generate bug fix
= 1.8 =
* On renew or resubscribe new license generate bug fix
= 1.9 =
* On renew support time update issue fixed